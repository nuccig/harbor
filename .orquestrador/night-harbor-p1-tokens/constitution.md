# Constitution — Harbor night-harbor-p1-tokens

> Reutilizada da run tela-de-configuracoes-onboarding-e-ui-alem-do (aprovado pelo usuário).
> Única mudança: artifacts_dir.
...
branching: feat/<slug> (esta run: feat/night-harbor-p1-tokens, stacked sobre codex/issue-29-configuracoes-onboarding-ui / PR #2)
...
test_expectations:
  feature: verify gate green (lint + typecheck + test); testes existentes não regridem; novos tokens cobertos por assert de presença quando aplicável
...
artifacts_dir: .orquestrador/night-harbor-p1-tokens/
